...
function ChatScreen(props) {
  ...
  const sendVoiceNote = async () => {
    ...
    console.log('RandomFileName---', ranFileName , Result);
    const uploadUri =
  ...
  const sendFile = async (filename, uploadUri, uri) => {
    setLoading(true);
    // alert('IN STORAGE111');
      ...
      <View
        ...
        <View
          ...
          <View style={appStyles.settingTopButtons}>
            <TouchableOpacity
              onPress={() => {
                onStopRecord(), props.navigation.goBack();
              }}>
              <ImageView
              ...
              <View style={appStyles.chatsearchScreenInsertKeyword}>
                <View
                  ...
                  <TextInput
                    ...
                    // value={value}
                    autoCorrect={false}
                    placeholder={`Message ${props.route.params.chatName}`}
                    // placeholder="Message"  {props.route.params.chatName}
