...
const CheckParticipants = ({dropdownCheck, unlimitedCheck,participantsNumber,unlimitedParticipants}) => {
  ...
  _dropdown_6_onSelect = (idx, value) => {
    // console.log('Dsssswwqqqqq===========>',participantsNumber);
  ...
  const [check, setcheck] = useState(unlimitedParticipants);
  checkUnlimited = () => {
    unlimitedCheck(check);
    ...
    <View
      ...
      <TouchableOpacity
        ...
        <ModalDropdown
          ...
          defaultValue={participantsNumber == null ? defaultvalue : participantsNumber}
          options={items}
        />
      </TouchableOpacity>
    </View>
