...
export default function CategorySelectBottomSheet( {
  ...
  repeat,
    ...
    const [multi,setMulit] = useState(repeat)
    const [products, setProducts] = useState([
    //   { id: 1, txt: 'View All', isChecked: false },
      { id: 1, txt: 'Does not repeat', isChecked: false },
      { id: 2, txt: 'Every weekday (Mon-Fri)', isChecked: false },
      { id: 3, txt: 'Daily', isChecked: false },
      { id: 4, txt: 'Weekly', isChecked: false },
      { id: 5, txt: 'Monthly', isChecked: false },
      { id: 6, txt: 'Yearly', isChecked: false },
  ...
  setProducts(temp);
    ...
    return (
        <View style={appStyles.bottomSheetContainer}>
           ...
           <View style={{width:'60%',flexDirection:'row',flexWrap:'wrap',paddingVertical:check == true ?10:0}}>
            ...
            <View style={[appStyles.bottomSheetIconContainer,{width:'40%',alignItems:'center',justifyContent:'flex-end'}]}>
            <Text style={[appStyles.bottomSheetIconText,{marginVertical:20,marginRight:15}]}>{multi}</Text>
  ...
  onPress={(()=>first==true ?handleSort(item.txt,item.id):handleChange(item.txt,item.id))}
/>
        {/* <CheckBox
